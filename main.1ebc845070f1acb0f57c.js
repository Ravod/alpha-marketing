...

{
  ...
  var burger = document.querySelector(".header--button__BURGER");
  var ul = document.querySelector(".header--ul__MENU");
...

{
  ...
  var main_open = document.querySelector(".hero--button");
  var main_close = Array.from(document.querySelectorAll(".hero--img__CLOSE"));
  var modal = Array.from(document.querySelectorAll(".modal"));
  var main_form = document.querySelector(".hero--form");
  var toMain = document.querySelector(".TO_MAIN");
  main_open.addEventListener("click", function () {
    modal[0].classList.add("visible");
    window.scrollTo(0, 0);
  });
  main_close.forEach(function (v, i, a) {
...

{
  ...
  var buttons = Array.from(document.querySelectorAll(".vacancy--button"));
  ...
  var imgOpen = Array.from(document.querySelectorAll(".vacancy--img__OPEN"));
  var imgClose = Array.from(document.querySelectorAll(".vacancy--img__CLOSE"));
  var hiddenBlock = Array.from(document.querySelectorAll(".vacancy--div__HIDDEN"));
  imgOpen.forEach(function (v, i, a) {
    a[i].addEventListener("click", function () {
  ...
  imgClose.forEach(function (v, i, a) {
    a[i].addEventListener("click", function () {
      a[i].style.display = "none";
  ...
  var buttonRespond = document.querySelector(".vacancy--button__RESPOND");
  var _modal = Array.from(document.querySelectorAll(".modal"));
  buttonRespond.addEventListener("click", function () {
    _modal[0].classList.add("visible");
    window.scrollTo(0, 0);
  });
}
...

{
  ...
  var _imgOpen = Array.from(document.querySelectorAll(".advantages--img__OPEN"));
  var _imgClose = Array.from(document.querySelectorAll(".advantages--img__CLOSE"));
  var _hiddenBlock = Array.from(document.querySelectorAll(".advantages--div__HIDDEN"));
  _imgOpen.forEach(function (v, i, a) {
    a[i].addEventListener("click", function () {
      a[i].style.display = "none";
      _imgClose[i].style.display = "block";
      _hiddenBlock[i].style.display = "flex";
    });
  });
  _imgClose.forEach(function (v, i, a) {
    a[i].addEventListener("click", function () {
      a[i].style.display = "none";
      _imgOpen[i].style.display = "block";
      _hiddenBlock[i].style.display = "none";
    });
  });
}
...

{
  ...
  var _buttons = Array.from(document.querySelectorAll(".products--button"));
  _buttons.forEach(function (v, i, a) {
    a[i].addEventListener("click", function () {
      a[i].classList.add("selected");
      a.filter(function (v1, i1, a1) {
        return a1[i1] !== a[i];
  ...
  var swiper = new Swiper('.products--div__SWIPER', {
    effect: "coverflow",
    speed: 600,
    grabCursor: true,
    centeredSlides: true,
...

{
  ...
  var _swiper = new Swiper('.career--div__SWIPER', {
    loop: true,
    speed: 600,
    grabCursor: true,
    centeredSlides: true,
...

{
  ...
  var main_button = document.querySelector(".progress--button");
  var _modal2 = Array.from(document.querySelectorAll(".modal"));
  main_button.addEventListener("click", function () {
    _modal2[0].classList.add("visible");
    window.scrollTo(0, 0);
  });
}
...

{
  ...
  var _buttons2 = Array.from(document.querySelectorAll(".contacts--button"));
  var tel = Array.from(document.querySelectorAll(".tel"));
  var geo = Array.from(document.querySelectorAll(".geo"));
  var maps = Array.from(document.querySelectorAll(".map"));
  _buttons2.forEach(function (v, i, a) {
    a[i].addEventListener("click", function () {
      a[i].classList.add("selected");
      a.filter(function (v1, i1, a1) {
        return a1[i1] !== a[i];
      ...
      tel.filter(function (v1, i1, a1) {
        return a1[i1] !== tel[i];
      }).forEach(function (v2, i2, a2) {
        a2[i2].classList.remove("sel");
      });
      geo[i].classList.add("sel");
      geo.filter(function (v1, i1, a1) {
        return a1[i1] !== geo[i];
      }).forEach(function (v2, i2, a2) {
        a2[i2].classList.remove("sel");
      });
      maps[i].classList.add("sel");
      maps.filter(function (v1, i1, a1) {
        return a1[i1] !== maps[i];
      }).forEach(function (v2, i2, a2) {
        a2[i2].classList.remove("sel");
      });
